...
static rosidl_typesupport_introspection_c__MessageMember rm_decision_interfaces__msg__Refree__rosidl_typesupport_introspection_c__Refree_message_member_array[1] = {
  {
    "robot_hp",  // name
